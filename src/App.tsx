...
function ProtectedPage1() {
	return (
		<>
			<h3>Protected</h3>
			<p>
				Innovare conatus est, non mollis pertinacia sensus. Dux virtus percipit, mentis fortitudo
				resistit. Ideoque invenire necesse est, ut aperiam perspicuitatem.
			</p>
		</>
	);
}
function ProtectedPage2() {
	return (
		<>
			<h3>Protected 2</h3>
			<p>
				Innovation ist der Versuch, nicht schwache Durchhaltevermögen. Der Führer versteht Tugend,
				der Mut des Geistes widersteht. Daher muss man Klarheit finden.
			</p>
		</>
	);
}
